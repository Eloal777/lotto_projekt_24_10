...
class RuTranslation implements ITranslation {
  ...
  String get inDieserAppKnnenSieSichZahlenGenerierenLassenFr =>
      'В этом приложении вы можете генерировать номера для разных игр:\nПервая игра — Лото 6 из 49, вторая игра — Евроджекпот,\r\ndтретья игра — Супер 6,\n и четвертая игра — игра 77.\n Это всего лишь генератор случайных чисел. Он НЕ гарантирует вам выигрыш в какой-либо лотерее, он просто помогает вам выбрать номера для игры,если у вас нет идеи какие из них вам следует играть. \nВерсия 1.0.0';
  @override
